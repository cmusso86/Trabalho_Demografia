...
Pelo gráficos da Figuras \@ref(fig:razao) vemos que a razão de sexo ao nascer é maior, sendo os homens mais frequentes, e esse limiar se mantém mai sou menos constate até aproximandamente os 20-30 anos, quando o sexo feminino passa a prevalescer.  Isso se dá, como também vemos nas pirâmides que a mortalidade é maior para o sexo masculino. 

```{r, razao, fig.cap="razão"}
pop_completo %>% 
