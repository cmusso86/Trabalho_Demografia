...
idade_media_mediana %>% 
  ...
  kable(format="html", caption=titulo, booktabs = T, 
        linesep="", 
        align=c("c","r", "r"),
...
quali_dados %>% 
  ...
  kable(escape = F,format="latex",caption = "Índices de Whipple, Myers e Bachi por tipo de declaração da idade", booktabs = TRUE, linesep="", digits=2,
