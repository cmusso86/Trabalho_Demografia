...
A TFG é ligeriamente mais refinada que o indicador anterior por acrescentar uma informação que a medida anterior não possuía, que é a relação de nascimentos por mulheres em período reprodutivo. Entretanto, ainda há muita influência da estrutura etária, uma vez que a fecundidade feminina não é constante durante seu período fértil. 
Na Tabela \@ref(tab:tfg) abaixo podemos observar os resultados para os anos selecionados. Nesse caso o valor mais baixo foi observado em 2010 e o mais alto em 2019, e em 2021 o valor voltou a decrescer. 
...
Em relação a taxa bruta de mortalidade, o Global Burden of Disease (GBD) apresentou uma estimativa de 6,08 para o ano de 2019, valor muito próximo ao encontrado neste trabalho (5,90).
...
As tábuas de vida para o sexo feminino e masculino em 2021 são apresentadas, respectivamente, a seguir. Para os cálculos utilizou-se a TMI obtida no item b, por sexo. Já os fatores de separação foram calculados por meio dos microdados de mortalidade (SIM) para todas as faixas etárias. A raíz $l_0$ foi fixada em 100.000.
...
Por outro lado, ${}_{n}q_x$ é a probabilidade que uma pessoa, tendo alcançado a idade exata $x$, tem de morrer entre as idades $x$ e $x + n$. Nota-se que as probabilidades de morte para as primeiras faixas etárias são menores do que para as últimas, já que a
sobrevivência seria maior entre as pessoas mais jovens. No entanto, a mortalidade infantil ainda apresenta valores expressivos, como pode ser observado no gráfico.
