...
No modelo, $l_x$ representa o número de pessoas que alcançam com vida a idade exata x de uma uma geração inicial de $l_0$ nascimentos e, portanto, é uma função de sobrevivência que inicia num determinado momento, com toda a população ainda viva, e permite calcular a porcentagem dessa população ainda viva em qualquer outro momento ao longo do tempo. Assim, $l_0 = 1$ indica a geração inicial de nascimentos, que neste caso é 1, e $l_20$ e $l_60$ seria o número de pessoas que alcançam com vida a idade exata 20 e 60, respectivamente. Portanto, esses valores são as probabilidades de sobreviver a idade exata 20 e 60.
